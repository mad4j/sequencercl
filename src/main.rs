...
mod tests {
    ...
    #[test]
    fn test_integration_with_files() -> Result<()> {
        use std::io::Write;
        ...
        // Write test data
        file1.write_all(b"shared code segment")?;
        file2.write_all(b"this contains the shared code segment")?;
        ...
        let matches = find_matching_substrings(&data1, &data2, 5, 256, 1_000_000_007)?;

        // Verify we found matches for "share", "ared ", etc.
        assert!(!matches.is_empty());
